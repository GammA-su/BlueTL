...
cd rtmp_server
powershell.exe -Command "Invoke-WebRequest -Uri 'https://github.com/illuspas/nginx-rtmp-win32/archive/refs/heads/master.zip' -OutFile '../temp/nginx-rtmp-win32.zip'"
powershell.exe -Command "Expand-Archive -Path '../temp/nginx-rtmp-win32.zip' -DestinationPath '.'"
